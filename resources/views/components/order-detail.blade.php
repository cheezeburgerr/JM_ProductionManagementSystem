<div>
    ...
    <div class=" relative bg-white shadow-lg rounded-md text-left overflow-hidden text-black">
        ...
        <div class="p-4">
            ...
            <div class="flex justify-between">
                ...
                <div class="items-center">
                    ...
                    <x-modal  name="artist-modal"  focusable>
                       ...
                       {{-- <livewire:assign-modal :id="$data" :mode="'Artist'"/> --}}
                    ...
                    <x-modal  name="proceed-modal"  focusable>
                        ...
                        @php $data = $order['order_id'] @endphp
                       {{-- <livewire:assign-modal :id="$data" :mode="'Proceed'"/> --}}
          ...
          <div wire:key="element_{{ uniqid() }}">
            <livewire:lineup-table :id="$order['order_id']" wire:key="{{$order->order_id}}"/>
          </div>
        </div>
    </div>
