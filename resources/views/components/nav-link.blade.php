...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-teal-500 text-sm font-medium leading-5 text-teal-500 focus:outline-none focus:border-gray-100 transition duration-150 ease-in-out'
