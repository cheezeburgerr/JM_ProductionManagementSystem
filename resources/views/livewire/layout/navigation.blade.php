...
<nav x-data="{ open: false }" class="z-50 sticky top-0 bg-gray-100 border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('order-category')" :active="request()->routeIs('order-category')"  wire:navigate>
                        {{ __('Order') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('/')" :active="request()->routeIs('customer-service')"  wire:navigate>
                        {{ __('Customer Service') }}
                    </x-nav-link>
                </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-100  focus:outline-none focus:text-gray-100 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('order-category')" :active="request()->routeIs('order-category')" wire:navigate>
                {{ __('Order') }}
            </x-responsive-nav-link>
        </div>
